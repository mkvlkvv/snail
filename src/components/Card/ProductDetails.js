...
const ProductDetails = () => {
  ...
  const componentData = {
    ...
    tags: [
      "горшок", "растение", "дизайн", "интерьер", "природа", "шарм" 
    ],
    license: {
      ...
      <div className="product-detail">
        ...
        <div className="tab-content">
          ...
          {activeTab === "description" && (
            <p>
              Этот горшок для растений - настоящая находка! Вдохновленный классическими глиняными горшками, он добавит вашему виртуальному саду природного шарма. Реалистичный дизайн и удобный размер делают его идеальным выбором для любого проекта. Скачивайте и преображайте свой виртуальный мир уже сегодня!
            </p>
          )}
          {activeTab === "reviews" && (
            <p>
